...
if (isset($_POST['register'])) {
   ...
   if ($search_result) {
    ...
    echo" Data inserted are not inserted";}
}
...
<div class="panel panel-primary"  style=" margin:-12px 0 0 0 ">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="id" name="id"required style=" height:31px;"> 
  </div> 
...
<div class="form-group">
   ...
   <label class="btn btn-success btn-file">
    Browse... <input type="file" style="display: none;" onchange="readURL(this);" name="image" style="width:140px ; height:32px;">
